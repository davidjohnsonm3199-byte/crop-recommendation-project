...
1.Imputer – handles missing values
2.Transformer – applies log transformation
3.Scaler – standardizes data
4.ML Models – Logistic Regression, Random Forest, and XGBoost
5.Streamlit app – for user-friendly predictions
